...
public struct ChartOptions: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The chart mode.
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ChartOptions.Mode.self, forKey: .mode) {
      self.mode = value
    }
  ...
  public enum Mode: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .color: return try container.encode("COLOR")
      case .xRay: return try container.encode("X_RAY")
      case .stats: return try container.encode("STATS")
